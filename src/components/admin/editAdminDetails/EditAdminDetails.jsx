...
const EditAdminDetails = () => {
    ...
    return (
        <div className='editadmindetails'>
            <div className='editadminimage'><img className='editadminprofileimage' src={`https://doctorbackend-je62.onrender.com/` + adminDetails.profile_image} alt='admin'></img></div>
